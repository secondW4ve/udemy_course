...
public class UserControllerTest {
    ...
    @Test
    public void postUser_whenUserIsValid_userSavedIntoDatabase(){
        User user = TestUtil.createValidUser();
        postSignup(user, Object.class);
        assertThat(userRepository.count()).isEqualByComparingTo(1L);
    }

    @Test
    public void postUser_whenUserIsValid_receiveSuccessMessage(){
        User user = TestUtil.createValidUser();
        ResponseEntity<GenericResponse> response = postSignup(
                user,
    ...
    @Test
    public void postUser_whenUserHasLessLongThenRequiredUsername_receiveBadRequest(){
        User user = TestUtil.createValidUser();
    ...
    @Test
    public void postUser_whenUserHasLessLongThenRequiredDisplayName_receiveBadRequest(){
        User user = TestUtil.createValidUser();
    ...
    @Test
    public void postUser_whenUserHasLessLongThenRequiredPassword_receiveBadRequest(){
        User user = TestUtil.createValidUser();
    ...
    @Test
    public void postUser_whenUserHasDisplayNameExceedsTheLimit_receiveBadRequest(){
        User user = TestUtil.createValidUser();
        String valueOf256Chars = IntStream.rangeClosed(1,256).mapToObj(x -> "a").collect(Collectors.joining());
    ...
    @Test
    public void postUser_whenUserHasPasswordWithAllCharsInLowercase_receiveBadRequest(){
        User user = TestUtil.createValidUser();
    ...
    @Test
    public void postUser_whenUserHasPasswordWithAllCharsInUppercase_receiveBadRequest(){
        User user = TestUtil.createValidUser();
    ...
    @Test
    public void postUser_whenUserHasPasswordWithAllCharsAsNumbers_receiveBadRequest(){
        User user = TestUtil.createValidUser();
    ...
    @Test
    public void postUser_whenUserHasInvalidLengthName_receiveGenericMessageOfSizeError(){
        User user = TestUtil.createValidUser();
        user.setUsername("abc");
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
    ...
    public void postUser_whenUserHasInvalidPasswordPattern_receiveMessageOfPasswordPatternError(){
        ...
        assertThat(validationErrors.get("password")).
                isEqualTo("Password should have at least one lowercase, one uppercase letter and one number");
    }

    @Test
    public void postUser_whenAnotherUserAlreadyHasSameName_receiveBadRequest(){
    ...
    @Test
    public void postUser_whenAnotherUserAlreadyHasSameName_receiveMessageOfDuplicateUsername(){
        userRepository.save(TestUtil.createValidUser());
        User user = TestUtil.createValidUser();
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String,String> validationErrors = response.getBody().getValidationErrors();
    ...
    @Test
    public void getUsers_whenThereIsUserInDB_receivePageWithUserWithoutPassword(){
        userRepository.save(TestUtil.createValidUser());
    ...
    public void getUsers_whenPageIsRequestedFor3ItemsPerPageWhereTheDbHas20Users_receive3Users(){
        ...
        ResponseEntity<TestPage<Object>> response = getUsers(
                path,
    ...
    public void getUsers_whenPageSizeIsGreaterThan100_receivePageSizeAs100(){
        String path = API_1_0_USERS + "?size=101";
    ...
    @Test
    public void getUsers_whenUserIsLoggedIn_receivePageWithoutThatUser(){
    ...
    public void getUserByUsername_whenUserExist_receiveOK(){
        User user = TestUtil.createValidUser("test-user");
        userRepository.save(user);

        ResponseEntity<Object> response = getUsers(
                API_1_0_USERS + "/test-user",
    ...
    public void getUserByUsername_whenUserExist_receiveUserWithoutPassword(){
        ...
        assertThat(response.getBody().toString().contains("password")).isFalse();
    }

    @Test
    public void getUserByUsername_whenUserDoesntExist_receiveApiError(){
        ResponseEntity<ApiError> response = getUsers(
                API_1_0_USERS + "/test-user",
                new ParameterizedTypeReference<ApiError>() {});

        assertThat(response.getBody().getUrl()).isEqualTo(API_1_0_USERS + "/test-user");
    }
    ...
    public void putUser_whenAuthorizedUserSendsUpdateToAnotherUser_receiveForbidden(){
        ...
        long anotherUserId = user.getId() + 12;
    ...
    @Test
    public void putUser_whenAuthorizedUserSendsUpdateToAnotherUser_receiveApiError(){
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
        long anotherUserId = user.getId() + 12;
    ...
    @Test
    public void putUser_whenValidRequestBodyAuthorizedUser_receiveOK(){
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());

        UserUpdateViewModel updatedUser = createValidUserUpdateVM();
    ...
    @Test
    public void putUser_whenValidRequestBodyAuthorizedUser_displayNameUpdated(){
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_whenValidRequestBodyAuthorizedUser_receiveUserVMWithUpdatedDisplayName(){
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_withValidRequestBodyWithSupportedImageFromAuthorizedUser_receiveUserVMWithRandomImageName()
            throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_withValidRequestBodyWithSupportedImageFromAuthorizedUser_ImageIsStoredUnderProfileFolder()
            throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_withInvalidRequestBodyWithDisplayNameSizeLessThenMinAllowedFromAuthorizedUser_receiveBadRequest(){
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_withInvalidRequestBodyWithDisplayNameSizeMoreThenMaxAllowedFromAuthorizedUser_receiveBadRequest(){
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_withValidRequestBodyWithJpgImageFromAuthorizedUser_receiveOk()
            throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    @Test
    public void putUser_withValidRequestBodyWithGifImageFromAuthorizedUser_receiveBadRequest()
            throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    public UserUpdateViewModel createValidUserUpdateVM(){
        UserUpdateViewModel updatedUser = new UserUpdateViewModel();
        updatedUser.setDisplayName("newDisplayName");
        return updatedUser;
    }

    public String readFileToBase64(String fileName) throws IOException {
